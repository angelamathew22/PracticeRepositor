...
--department table
create table Department(Dept_no varchar(20)  null,
...
create table Works_on(emp_on integer not null,
project_no varchar(4) not null,
Job varchar(30) null,enter_date datetime null)
...
select emp_on from Works_on where Job='Clerk'

--Question 3

select emp_on from  Works_on where project_no='p2'

--Question 4

select * from Works_on where YEAR(enter_date)!=1998 
