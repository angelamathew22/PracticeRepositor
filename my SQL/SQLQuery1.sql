...
select * from sales where qty<(select Max(ord_date(qty) from sales)
select * from sales where qty<(select Min(ord_date(qty) from sales)
select * from stores
select * from sales where stor_id=(select stor_id-(select stor_id from stores where stor_name='bookbeat')
select * from sales where stor_id in(select stor_id from stores where stor_name in('bookbeat')
