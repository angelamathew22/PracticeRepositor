...
use Assignment2
--department table
create table Department(Dept_no integer  null,
Dept_name varchar(30)null,
location varchar(30)null)
Alter table Department Alter column Dept_no varchar(5) not null
...
create table Works_no(emp_on integer not null,
